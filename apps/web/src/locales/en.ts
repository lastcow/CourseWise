export const en = {
  translation: {
    ...
    assignments: {
      ...
      unassignedModule: 'No module',
      moduleUpdated: 'Module updated',
      groupLabel: 'Grading category or set',
      unassignedGroup: 'Unassigned',
      groupOptCategories: 'Categories',
      groupOptSets: 'Assignment sets',
      groupSetHint:
        'Put this assignment directly in a weighted category, or in a set whose average/best-of feeds a category.',
    ...
    grading: {
      ...
      setsCardTitle: 'Assignment sets',
      setsCardHint:
        'Bundle several assignments into a set. Members are graded individually, but the set contributes one score (average or best-of) to its category.',
      setsEmpty: 'No sets yet. Add one to bundle assignments.',
      setAdd: '+ Add set',
      setDelete: 'Delete',
      setNameAria: 'Set name',
      setCategoryAria: 'Set category',
      setNoCategory: 'No category',
      setRuleAria: 'Set scoring rule',
