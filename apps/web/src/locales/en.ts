export const en = {
  translation: {
    ...
    settings: {
      ...
      integrations: {
        ...
        canvas: {
          ...
          importDescription:
            'Pick one of your Canvas courses and CourseWise will create a new course from it — structure only, imported as drafts. No student data is touched.',
    ...
    canvas: {
      ...
      importConfirmBody:
        'Course structure only, created as drafts. No student data is touched and nothing is published.',
      ...
      rosterCardTitle: 'Roster & identity links',
      rosterCardBody:
        'Match Canvas roster entries to registered CourseWise students. Suggestions always need your confirmation — nothing links automatically.',
      rosterCardCta: 'Open roster reconciliation',
      roster: {
        title: 'Canvas roster reconciliation',
        description:
          'Link Canvas roster entries to CourseWise students. Every link needs your explicit confirmation; names alone never auto-match.',
        needLinkTitle: 'Connect and link first',
        needLinkBody: 'This course is not linked to a Canvas course yet.',
        goToSync: 'Open Canvas sync',
        refreshCta: 'Refresh Canvas roster',
        refreshing: 'Refreshing…',
        refreshStarted: 'Roster refresh started.',
        lastFetched: 'Roster fetched {{date}}',
        neverFetched: 'Roster not fetched yet — refresh to pull it from Canvas.',
        visibilityTitle: 'Your Canvas permissions expose:',
        visEmail: 'email {{visible}}/{{total}}',
        visSis: 'SIS ID {{visible}}/{{total}}',
        visLogin: 'login ID {{visible}}/{{total}}',
        suggestedTitle: 'Suggested matches ({{count}})',
        suggestedEmpty:
          'No suggestions right now — link students manually below, or refresh the roster.',
        selectAll: 'Select all',
        selectNone: 'Clear selection',
        selectRow: 'Select match',
        confirmSelected: 'Confirm selected ({{count}})',
        confirmOne: 'Link',
        confirmCta: 'Confirm links',
        confirmTitle: 'Confirm identity links?',
        confirmBody:
          '{{count}} student(s) will be linked to their Canvas identity. Each link is recorded in the disclosure log.',
        confirmed: '{{count}} linked.',
        method: {
          sis: 'Student number match',
          email: 'Email match',
          login_id: 'Login ID match',
          manual: 'Linked manually',
        },
        confirmedTitle: 'Confirmed links ({{count}})',
        confirmedEmpty: 'No confirmed links yet.',
        unlinkCta: 'Unlink',
        unlinkTitle: 'Remove this identity link?',
        unlinkBody:
          'The student stays enrolled in CourseWise; only the Canvas identity link is removed.',
        unlinked: 'Link removed.',
        cwOnlyTitle: 'Only in CourseWise ({{count}})',
        cwOnlyEmpty: 'Every registered student is linked or suggested.',
        cwOnlyBadge: 'Not on Canvas roster',
        ambiguousBadge: 'Ambiguous — link manually',
        manualLink: 'Link manually',
        manualPlaceholder: 'Pick a Canvas entry…',
        canvasOnlyTitle: 'Only in Canvas ({{count}})',
        canvasOnlyEmpty: 'Every Canvas roster entry is linked or suggested.',
        canvasOnlyHint:
          'These students have not registered in CourseWise yet. Share the course invitation code to bring them in — accounts are never created from the roster.',
        notRegistered: 'Not registered',
        inviteCta: 'Open invitation codes',
        droppedBadge: 'Dropped in Canvas',
        colStudent: 'CourseWise student',
        colCanvas: 'Canvas entry',
        colMethod: 'Match basis',
        colStatus: 'Status',
        colSections: 'Sections',
        scheduleTitle: 'Nightly roster refresh',
        scheduleBody:
          'During the add/drop period, refresh the Canvas roster automatically every night. Stops on the date you pick or when the Canvas token dies.',
        scheduleUntil: 'Refresh until',
        scheduleEnable: 'Enable nightly refresh',
        scheduleDisable: 'Disable',
        scheduleOn: 'On until {{date}}',
        scheduleSaved: 'Schedule saved.',
      },
      run: {
        kind: { initial_import: 'Import', structure_push: 'Push', roster_refresh: 'Roster' },
        pushModules:
        ...
        rosterRefresh:
          'Roster: {{entries}} entries — {{added}} new, {{updated}} updated, {{disappeared}} dropped in Canvas, {{reappeared}} returned',
      },
    },
    admin: {
      deletionLog: {
    ...
    announcements: {
      title: 'Announcements',
      helpTeacher: 'Post course-wide announcements. Save a draft, then publish when ready.',
      helpStudent: 'Announcements from your teacher for this course.',
      newCta: '+ New announcement',
      empty: 'No announcements yet.',
      emptyStudent: 'No announcements yet.',
      new: 'New',
      ...
      fieldBody: 'Message',
      bodyPlaceholder: 'Write your announcement… (Markdown supported)',
      ...
      deleteConfirm: 'This permanently deletes the announcement. This cannot be undone.',
      readStat: '{{read}}/{{total}} read',
      pin: 'Pin',
      unpin: 'Unpin',
      validationAudience: 'Select at least one group',
      fieldAudience: 'Audience',
      audienceCourse: 'Everyone in the course',
      audienceGroups: 'Specific groups',
      audienceGroupsCount: '{{count}} group(s)',
      pickGroupSet: 'Choose a group set…',
    ...
    assignments: {
      ...
      expandSubmissions: 'Show submissions',
      collapseSubmissions: 'Hide submissions',
      colActions: 'Actions',
    ...
    submissions: {
      ...
      rosterSearchStudents: 'Search students',
      rosterSearchGroups: 'Search groups or students',
      rosterEmpty: 'No submissions yet.',
      rosterNoMatch: 'No matches.',
      noSubmissionGroup: 'No submission yet',
