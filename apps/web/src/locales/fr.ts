export const fr = {
  translation: {
    ...
    canvas: {
      ...
      rosterCardTitle: 'Effectifs et liens d\'identité',
      rosterCardBody:
        'Associez les entrées de l\'effectif Canvas aux étudiants inscrits dans CourseWise. Les suggestions exigent toujours votre confirmation — aucun lien automatique.',
      rosterCardCta: 'Ouvrir le rapprochement des effectifs',
      roster: {
        title: 'Rapprochement de l\'effectif Canvas',
        description:
          'Liez les entrées de l\'effectif Canvas aux étudiants CourseWise. Chaque lien exige votre confirmation explicite ; un nom seul ne crée jamais de correspondance.',
        needLinkTitle: 'Connectez et liez d\'abord',
        needLinkBody: 'Ce cours n\'est pas encore lié à un cours Canvas.',
        goToSync: 'Ouvrir la synchronisation Canvas',
        refreshCta: 'Actualiser l\'effectif Canvas',
        refreshing: 'Actualisation…',
        refreshStarted: 'Actualisation de l\'effectif lancée.',
        lastFetched: 'Effectif récupéré le {{date}}',
        neverFetched: 'Effectif pas encore récupéré — actualisez pour le charger depuis Canvas.',
        visibilityTitle: 'Vos permissions Canvas exposent :',
        visEmail: 'email {{visible}}/{{total}}',
        visSis: 'ID SIS {{visible}}/{{total}}',
        visLogin: 'identifiant {{visible}}/{{total}}',
        suggestedTitle: 'Correspondances suggérées ({{count}})',
        suggestedEmpty:
          'Aucune suggestion pour l\'instant — liez manuellement ci-dessous ou actualisez l\'effectif.',
        selectAll: 'Tout sélectionner',
        selectNone: 'Effacer la sélection',
        selectRow: 'Sélectionner la correspondance',
        confirmSelected: 'Confirmer la sélection ({{count}})',
        confirmOne: 'Lier',
        confirmCta: 'Confirmer les liens',
        confirmTitle: 'Confirmer les liens d\'identité ?',
        confirmBody:
          '{{count}} étudiant(s) seront liés à leur identité Canvas. Chaque lien est consigné dans le journal des divulgations.',
        confirmed: '{{count}} lié(s).',
        method: {
          sis: 'Numéro étudiant identique',
          email: 'Email identique',
          login_id: 'Identifiant identique',
          manual: 'Lié manuellement',
        },
        confirmedTitle: 'Liens confirmés ({{count}})',
        confirmedEmpty: 'Aucun lien confirmé pour l\'instant.',
        unlinkCta: 'Délier',
        unlinkTitle: 'Supprimer ce lien d\'identité ?',
        unlinkBody:
          'L\'étudiant reste inscrit dans CourseWise ; seul le lien d\'identité Canvas est supprimé.',
        unlinked: 'Lien supprimé.',
        cwOnlyTitle: 'Seulement dans CourseWise ({{count}})',
        cwOnlyEmpty: 'Chaque étudiant inscrit est lié ou suggéré.',
        cwOnlyBadge: 'Absent de l\'effectif Canvas',
        ambiguousBadge: 'Ambigu — lier manuellement',
        manualLink: 'Lier manuellement',
        manualPlaceholder: 'Choisir une entrée Canvas…',
        canvasOnlyTitle: 'Seulement dans Canvas ({{count}})',
        canvasOnlyEmpty: 'Chaque entrée de l\'effectif Canvas est liée ou suggérée.',
        canvasOnlyHint:
          'Ces étudiants ne se sont pas encore inscrits dans CourseWise. Partagez le code d\'invitation du cours — aucun compte n\'est jamais créé depuis l\'effectif.',
        notRegistered: 'Non inscrit',
        inviteCta: 'Ouvrir les codes d\'invitation',
        droppedBadge: 'Retiré dans Canvas',
        colStudent: 'Étudiant CourseWise',
        colCanvas: 'Entrée Canvas',
        colMethod: 'Base de correspondance',
        colStatus: 'Statut',
        colSections: 'Sections',
        scheduleTitle: 'Actualisation nocturne de l\'effectif',
        scheduleBody:
          'Pendant la période d\'inscription, actualisez automatiquement l\'effectif Canvas chaque nuit. S\'arrête à la date choisie ou si le jeton Canvas expire.',
        scheduleUntil: 'Actualiser jusqu\'au',
        scheduleEnable: 'Activer l\'actualisation nocturne',
        scheduleDisable: 'Désactiver',
        scheduleOn: 'Active jusqu\'au {{date}}',
        scheduleSaved: 'Planification enregistrée.',
      },
      run: {
        kind: { initial_import: 'Import', structure_push: 'Poussée', roster_refresh: 'Effectifs' },
        pushModules:
        ...
        rosterRefresh:
          'Effectif : {{entries}} entrées — {{added}} nouvelles, {{updated}} mises à jour, {{disappeared}} retirées dans Canvas, {{reappeared}} revenues',
      },
    },
    admin: {
      deletionLog: {
    ...
    announcements: {
      title: 'Annonces',
      helpTeacher:
        'Publiez des annonces pour tout le cours. Enregistrez un brouillon, puis publiez.',
      helpStudent: 'Annonces de votre enseignant pour ce cours.',
      newCta: '+ Nouvelle annonce',
      empty: 'Aucune annonce pour le moment.',
      emptyStudent: 'Aucune annonce pour le moment.',
      new: 'Nouveau',
      ...
      fieldBody: 'Message',
      bodyPlaceholder: 'Rédigez votre annonce… (Markdown pris en charge)',
      saveDraft: 'Enregistrer le brouillon',
      publish: 'Publier',
      unpublish: 'Dépublier',
      archive: 'Archiver',
      saved: 'Annonce enregistrée',
      validationRequired: 'Le titre et le message sont obligatoires',
      deleteTitle: 'Supprimer l’annonce',
      deleteConfirm: 'Cela supprime définitivement l’annonce. Action irréversible.',
      readStat: '{{read}}/{{total}} lu',
      pin: 'Épingler',
      unpin: 'Désépingler',
      validationAudience: 'Sélectionnez au moins un groupe',
      fieldAudience: 'Destinataires',
      audienceCourse: 'Tout le cours',
      audienceGroups: 'Groupes spécifiques',
      audienceGroupsCount: '{{count}} groupe(s)',
      pickGroupSet: 'Choisir un ensemble de groupes…',
