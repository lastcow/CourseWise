export const fr = {
  translation: {
    ...
    assignments: {
      ...
      unassignedModule: 'Aucun module',
      moduleUpdated: 'Module mis à jour',
      groupLabel: 'Catégorie ou ensemble',
      unassignedGroup: 'Non assigné',
      groupOptCategories: 'Catégories',
      groupOptSets: 'Ensembles de devoirs',
      groupSetHint:
        'Placez ce devoir directement dans une catégorie pondérée, ou dans un ensemble dont la moyenne / le meilleur score alimente une catégorie.',
    ...
    grading: {
      ...
      setsCardTitle: 'Ensembles de devoirs',
      setsCardHint:
        'Regroupez plusieurs devoirs en un ensemble. Les membres sont notés individuellement, mais l’ensemble fournit un seul score (moyenne ou meilleur) à sa catégorie.',
      setsEmpty: 'Aucun ensemble pour l’instant. Ajoutez-en un pour regrouper des devoirs.',
      setAdd: '+ Ajouter un ensemble',
      setDelete: 'Supprimer',
      setNameAria: 'Nom de l’ensemble',
      setCategoryAria: 'Catégorie de l’ensemble',
      setNoCategory: 'Aucune catégorie',
      setRuleAria: 'Règle de calcul de l’ensemble',
      ...
      newSetDefaultName: 'Nouvel ensemble',
