export const fr = {
  translation: {
    ...
    messages: {
      ...
      deleteConfirm: 'Supprimer cette conversation de votre boîte de réception ?',
    ...
    assignments: {
      ...
      setDeleteConfirm: 'Supprimer l’ensemble « {{name}} » ?',
      ...
      setWeightsHint: 'Les scores se combinent selon le poids (part = poids ÷ total). Les membres non notés sont ignorés.',
    ...
    submissions: {
      ...
      selectPrompt: 'Sélectionnez la soumission d’un étudiant dans la liste pour commencer la notation.',
    ...
    discussion: {
      ...
      postDeleteConfirm: 'Supprimer ce message ?',
    ...
    quizzes: {
      ...
      pickAttempt: 'Sélectionnez la tentative d’un étudiant dans la liste pour commencer la notation.',
      ...
      gradingPendingHint: 'Certaines réponses doivent encore être notées — le total se mettra à jour au fil de la notation.',
      ...
      submitCta: 'Envoyer',
      submitConfirm:
        'Envoyer votre quiz maintenant ? Vous ne pourrez plus modifier vos réponses ensuite.',
    ...
    grading: {
      ...
      groupDeleteConfirm: 'Supprimer la catégorie « {{name}} » ?',
    ...
    ai: {
      ...
      prompts: {
        ...
        resetConfirm:
          'Réinitialiser ce modèle aux valeurs par défaut intégrées ? Vos modifications seront perdues.',
        ...
        discardConfirm: 'Abandonner vos modifications non enregistrées et changer ?',
        validation: {
